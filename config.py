...
# List of your favorite teams. This will decide which games" scores are displayed live.
...
# The time you would like the display to sleep. Include AM/PM or format in military time.
# This will not work unless WAKE_TIME is also set.
# Example: SLEEP_TIME = "11:00 PM"
SLEEP_TIME = ""

# The time you would like the display to wake. Include AM/PM or format in military time.
# This will not work unless SLEEP_TIME is also set.
# Example: WAKE_TIME = "10:00 AM"
WAKE_TIME = ""

# The day you would like the display to sleep, where Monday is 1 and Sunday is 7.
# This will not work unless WAKE_DAY is also set.
# Example: SLEEP_DAY = 1
SLEEP_DAY = 0

# The day you would like the display to wake, where Monday is 1 and Sunday is 7.
...
# List of valid timezones, for reference
